...
import { loadVendidos } from '@/lib/investimento-queries'
...
export default function VendasPageClient() {
  ...
  const load = useCallback(async () => {
    ...
    try {
      const rows = await loadVendidos(supabase)
      setVendas(rows)
      setError(null)
    } catch {
          ...
          <div className="mx-auto max-w-4xl space-y-6 px-4 py-6 sm:px-6 lg:px-8">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                As peças que moveste para &quot;vendidos&quot; no Investimento. Seleciona peças para
                somar o que ganhaste com elas.
              </p>
            </div>
